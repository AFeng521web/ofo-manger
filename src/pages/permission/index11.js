...
export default class Permission extends React.Component {
    ...
    handleUserSubmit = ()=> {
        ...
        data.role_id = this.state.selectedItem.id;
        axios.ajax({
            url: '/permission/user_role_edit.json',
            data: {
                params: {
                    ...data
                }
        ...
        const columns = [
            {
                ...
                render: Utils.formateDate("create_time")
            }, {
                title: '使用状态',
                dataIndex: 'status',
                render(status) {
                ...
                render: Utils.formateDate("authorize_time")
            }, {
                title: '授权人',
